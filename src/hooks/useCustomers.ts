...
type ApiResponse = { message?: string; customers?: ApiCustomer[] } & Record<string, unknown>;
...
function normalizeCustomer(raw: ApiCustomer): Customer {
  return {
    ...
    firstContactChannel: asNullableString(raw.firstContactChannel)?.toLowerCase() ?? null,
    ...
    hybridInverterPreference: asNullableString(raw.hybridInverterPreference)?.toLowerCase() ?? null,
